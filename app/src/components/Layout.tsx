...
const rightNav = [
  ...
  { to: '/import', icon: 'upload_file', label: 'More' },
];
...
export function Layout() {
  return (
    <div className="min-h-dvh pb-24">
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 left-0 w-full z-50 flex items-end justify-center px-4 pb-6 pt-3 bg-white/80 backdrop-blur-3xl rounded-t-3xl shadow-[0_-20px_40px_rgba(19,27,46,0.04)]">
        <div className="flex items-center justify-around w-full max-w-md">
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className="font-headline font-medium text-[9px] tracking-wide uppercase mt-0.5">
                    {item.label}
                  </span>
          ...
          >
            ...
            <span className="font-headline font-semibold text-[9px] tracking-wide uppercase mt-1 text-on-primary-fixed">
              Add
            </span>
          </NavLink>
